...
export default function Contact() {
  return (
    <section className="min-h-screen py-32 px-8 flex items-center">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.h1
          ...
          viewport={{ once: true }}
          className="text-6xl md:text-8xl font-bold mb-10 text-gray-800"
        >
          Let's Work Together
        </motion.h1>
        ...
        >
          <a
            ...
            className="inline-block bg-blue-600 text-white px-12 py-6 rounded-full text-xl font-semibold hover:bg-blue-700 transition shadow-xl hover:shadow-2xl"
          >
        ...
        <motion.div
          ...
          className="flex justify-center gap-12 text-gray-600"
        >
